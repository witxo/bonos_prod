      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="bono_validado_c" value="0"><input type="checkbox" id="bono_validado_c" name="bono_validado_c" value="1" {if $fields.bono_validado_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        4 => 
        array (
        ...
        array (
          ...
          array (
            ...
            'label' => 'LBL_ASISTENCIA1',
             'customCode' => '<input type="hidden" name="asistencia1_c" value="0"><input type="checkbox" id="asistencia1_c" name="asistencia1_c" value="1" {if $fields.asistencia1_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        1 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="asistencia2_c" value="0"><input type="checkbox" id="asistencia2_c" name="asistencia2_c" value="1" {if $fields.asistencia2_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        2 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="asistencia3_c" value="0"><input type="checkbox" id="asistencia3_c" name="asistencia3_c" value="1" {if $fields.asistencia3_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        3 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="asistencia4_c" value="0"><input type="checkbox" id="asistencia4_c" name="asistencia4_c" value="1" {if $fields.asistencia4_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        4 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="asistencia5_c" value="0"><input type="checkbox" id="asistencia5_c" name="asistencia5_c" value="1" {if $fields.asistencia5_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        5 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="asistencia6_c" value="0"><input type="checkbox" id="asistencia6_c" name="asistencia6_c" value="1" {if $fields.asistencia6_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        6 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="asistencia7_c" value="0"><input type="checkbox" id="asistencia7_c" name="asistencia7_c" value="1" {if $fields.asistencia7_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        7 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="asistencia8_c" value="0"><input type="checkbox" id="asistencia8_c" name="asistencia8_c" value="1" {if $fields.asistencia8_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        8 => 
        array (
          ...
          array (
           ...
           'customCode' => '<input type="hidden" name="asistencia9_c" value="0"><input type="checkbox" id="asistencia9_c" name="asistencia9_c" value="1" {if $fields.asistencia9_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
        9 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input type="hidden" name="asistencia10_c" value="0"><input type="checkbox" id="asistencia10_c" name="asistencia10_c" value="1" {if $fields.asistencia10_c.value == "1"} checked {/if} {$disabled}>',
          ),
        ),
      ),
    ),
