...
$total_precio = 0;
	 ...
	 while ($row = mysql_fetch_object($handle)) 
	 {
       ...
       $ingreso_al = getIngresoAlumnoAsignatura ($row->cuentaid, $row->nombrec, $mes);
...
$profeid = getUserAccount ($id);
  ...
  $gastos_profe = $sueldo_profe + $ss_profe + $irpf_profe;
	 	 ...
	 	 echo "<tr><td>TOTAL Gastos</td><td></td><td><td></td></td><td></td><td></td><td></td><td>".number_format($gastos_profe,2)."</td></tr>";

$diferencia = $total_precio - $gastos_profe;

if ($diferencia > 0)
  echo "<tr><td>BENEFICIO</td><td></td><td><td></td></td><td></td><td></td><td></td><td>".number_format($diferencia,2)."</td></tr>";
else
  echo "<tr><td>PERDIDA</td><td></td><td><td></td></td><td></td><td></td><td></td><td>".number_format($diferencia,2)."</td></tr>";
